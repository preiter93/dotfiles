return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>hf', function() require('harpoon.ui').nav_file(3) end, { desc = '[H]arpoon [3]' })
    vim.keymap.set('n', '<leader>hd', function() require('harpoon.ui').nav_file(4) end, { desc = '[H]arpoon [4]' })
  end
}
